    ...
    function renderAbout() {
        ...
        <div class="about-wrap">
            ...
            <figure class="about-portrait">
                ...
                <figcaption><strong>Зая-Пандита Намкай Гьяцо — создатель Тодо Бичик</strong></figcaption>
            </figure>
        ...
        const sections = [
            {
                ...
                body: `
                    ${dirSvg}
                    <p>Тодо Бичик — вертикальное письмо: буквы «нанизываются» сверху вниз на невидимую вертикальную ось, которая по-калмыцки называется ${wrGlyph('nurγun')} — «хребет». Один столбец соответствует примерно одной строке привычного горизонтального письма.</p>
                    <p>Столбцы располагаются и читаются <strong>слева направо</strong> — так же, как в старомонгольской письменности, из которой выросло Тодо Бичик. Поэтому лист или страница заполняются последовательно: дописали столбец до конца — переходят к следующему, правее.</p>`
            },
            {
