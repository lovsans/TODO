/* lessons.js — учебный контент и упражнения со словами (о письме, курс, правила,
   слова, силлабарий, конструктор «Составить слово» и «Написать слово», карточки). */
    ...
    function wrTakeaway(html) {
        return `<aside class="wr-takeaway" role="note"><span class="wr-takeaway-label">Запомни</span><div class="wr-takeaway-body">${html}</div></aside>`;
    }
        ...
        const sections = [
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Внутри столбца — сверху вниз; столбцы — слева направо.')}`
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Любой знак собирается из этих строительных элементов на оси нурһн.')}`
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Сначала всё слово целиком — диакритику расставляют в конце, снизу вверх и по часовой стрелке.')}`
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Форма буквы зависит от позиции: начало, середина или конец слова.')}`
            },
            {
            ...
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Начальная гласная — с короной; «у» отличается от «ү» чертой; твёрдые х/һ/к — только с: «а, о, у».')}
            ...
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Круглые б, п, к, г с круглой гласной пишутся одним слитным росчерком.')}`
            },
            {
                ...
                body: `
                    ...
                    ${wrTakeaway('Галики — для заимствований; пунктуация и цифры — отдельные знаки письма.')}`
            },
            {
                title: 'Частые ошибки',
                kind: 'ошибки',
