   ...
   слова, силлабарий, конструктор «Составить слово» и «Написать слово», карточки). */
    ...
    function renderAbout() {
        ...
        <div class="about-wrap">
            ...
            <p class="about-lead">Добро пожаловать на специализированный сайт, полностью посвящённый <strong>Тодо Бичик</strong> (ойр. <span class="about-oirat" lang="x-tod">ᡐᡆᡑᡆ ᡋᡅᡔᡅᡎ</span> — «ясное, чёткое письмо») — одной из самых совершенных и самобытных письменных систем в монгольском мире.</p>
            ...
            <p>В 1648 году, в эпоху расцвета Джунгарского ханства, выдающийся ойратский просветитель, буддийский монах и политический деятель За́я-панди́та Намкай Гьяцо (тиб. nam mkha'i rgya mtsho; калм. Зая-пандит Оһторһун Дала; монг. Зая-бандид Огторгуйн Далай / Намхайжамц; 1599–1662) создал новый алфавит «Тодрха Үзг» (todorxoi üzüq). Это произошло во время празднования Белого месяца (ойр. Цаган Сара) в период зимовки у Аблая-тайши на реке Чуй, по инициативе ойратской правящей элиты, при поддержке Эрдэни-Батура Хунтайджи.</p>
            <p>Зая-пандита взял за основу классическое монгольское (уйгуро-монгольское) письмо, но существенно его усовершенствовал. Главная цель — сделать письменность максимально близкой к нормам живой монгольской речи. В монгольском письме многие графемы не различались, что создавало трудности при чтении и особенно при передаче иностранных (в первую очередь тибетских и санскритских) терминов буддийских текстов. Создание Тодо Бичик устранило эту многозначность: появились новые буквы, диакритические знаки, чёткое разделение гласных и согласных, что сделало письмо по-настоящему «ясным» и фонетически точным. За всю историю существования монгольские народы пользовались примерно 10 письменными системами. Очевидно, что Тодо Бичик среди всех этих письменностей является единственной фонетической графической системой.</p>

            <h3 class="about-h3">Значение Тодо Бичик</h3>
            <p>За свою жизнь Зая-пандита перевёл с тибетского на ойратский язык больше 200 произведений — от канонических буддийских текстов до философских трактатов, медицинских сочинений, сутр, легенд и молитв. Благодаря новому письму эти знания стали доступны широкому кругу ойратских читателей.</p>
            <p class="about-wiki-note">Подробнее о создателе письма: <a href="https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D1%8F-%D0%9F%D0%B0%D0%BD%D0%B4%D0%B8%D1%82%D0%B0" target="_blank" rel="noopener noreferrer">Зая-пандита в Википедии</a></p>
            <p>Тодо Бичик — письменность, которая быстро распространилась среди ойратов и соседних народов. Она использовалась в деловой переписке, религиозной литературе, летописях и повседневной жизни вплоть до первой половины XX века. У калмыков письменность активно использовалась до 1924 года, пока не была заменена кириллицей → латиницей, а затем снова → кириллицей. В некоторых регионах Китая (среди ойратов) традиции использования Тодо Бичик сохраняются и по сей день.</p>
            <p>Сайт будет интересен историкам, лингвистам, студентам, востоковедам и преподавателям, а также всем, кто увлекается культурой Центральной Азии, буддизмом и уникальным наследием ойратской культуры.</p>
            <blockquote class="about-quote"><strong>Тодо Бичик</strong> — это не просто алфавит. Это величественный символ интеллектуального расцвета ойратов, базовая часть культурного кода, позволяющая сохранять связь поколений, передавать глубокую мудрость предков, обогащённую индийской и тибетской культурой, пришедшей вместе с буддийской традицией.</blockquote>
            <p><strong>Присоединяйтесь к нам, чтобы открыть для себя одну из самых ярких страниц монгольской истории!</strong></p>

            <h3 class="about-h3">Как устроено письмо</h3>
            <p>Буквы пишутся сверху вниз, строкой служит вертикальная линия, на которую «нанизываются» знаки — так же, как и в монгольской вертикальной письменности, из которой выросло Тодо Бичик. У большинства букв — три формы начертания: начальная, срединная и конечная, а гласные и согласные соединяются в слоги по строгим правилам, которые собраны в силлабарии этого сайта.</p>

            <h3 class="about-h3">Как пользоваться сайтом</h3>
            <p class="about-method-intro">Коротко о том, с чего начать и как считается прогресс.</p>
            <div class="about-howto">
                <ul class="about-howto-list">
                    <li><strong>С чего начать.</strong> Идите по разделу <button type="button" class="about-inline-link" onclick="showSection('path')">Путь</button> — уроки строго по порядку; или откройте тренировку и закрепите знаки по одной теме.</li>
                    <li><strong>Когда знак «выучен».</strong> Нужно верно ответить по каждой форме (начало · середина · конец), если у знака они есть.</li>
                    <li><strong>Слоги.</strong> Тренируются сериями: следующая открывается примерно с 70% предыдущей; при 100% сайт сам переходит дальше.</li>
                    <li><strong>Прогресс.</strong> Хранится в этом браузере. В тренировке можно экспортировать и импортировать файл, чтобы не потерять результат.</li>
                </ul>
                <div class="about-howto-actions">
                    <button type="button" class="course-go" onclick="showSection('path')">Открыть Путь →</button>
                    <button type="button" class="course-go" onclick="showSection('practice_vowels')">К тренировке →</button>
                </div>
            </div>
    ...
    // ============================================================
    // О НАС — проект и А. В. Бадмаев
    // ============================================================
    function renderAboutUs() {
        return `
        <div class="about-wrap">
            <div class="about-hero" id="about-us-hero">
                <div>
                    <div class="about-kicker">О проекте</div>
            ...
            <details class="about-pwa-details">
                ...
                <div class="about-pwa">
                    <section class="about-pwa-platform" aria-labelledby="pwa-ios">
                        <div class="about-pwa-head">
                            <h4 class="about-pwa-title" id="pwa-ios">iPhone и iPad</h4>
                            <p class="about-pwa-browser">Только в Safari</p>
                        </div>
                        <ol class="about-pwa-steps">
                            <li>Откройте этот сайт в Safari.</li>
                            <li>Нажмите кнопку «Поделиться» <span class="about-pwa-hint">(квадрат со стрелкой вверх)</span>.</li>
                            <li>Выберите «На экран „Домой“».</li>
                            <li>Подтвердите «Добавить».</li>
                        </ol>
                    </section>

                    <section class="about-pwa-platform" aria-labelledby="pwa-android">
                        <div class="about-pwa-head">
                            <h4 class="about-pwa-title" id="pwa-android">Android</h4>
                            <p class="about-pwa-browser">Chrome</p>
                        </div>
                        <ol class="about-pwa-steps">
                            <li>Откройте этот сайт в Chrome.</li>
                            <li>Нажмите меню <span class="about-pwa-hint">⋮</span> в правом верхнем углу.</li>
                            <li>Выберите «Установить приложение» или «Добавить на главный экран».</li>
                            <li>Подтвердите установку.</li>
                        </ol>
                        <p class="about-pwa-note">Если пункта нет — обновите страницу и откройте меню снова.</p>
                    </section>

                    <section class="about-pwa-platform" aria-labelledby="pwa-pc">
                        <div class="about-pwa-head">
                            <h4 class="about-pwa-title" id="pwa-pc">Компьютер</h4>
                            <p class="about-pwa-browser">Chrome или Edge</p>
                        </div>
                        <ol class="about-pwa-steps">
                            <li>Откройте сайт в Chrome или Edge.</li>
                            <li>В адресной строке нажмите значок установки <span class="about-pwa-hint">(⊕ или значок компьютера)</span>.</li>
                            <li>Либо откройте меню браузера → «Установить Тодо Бичик…».</li>
                            <li>Подтвердите — сайт откроется в отдельном окне.</li>
                        </ol>
                    </section>
                </div>
            </details>
            ...
            <p>Такой порядок занятий опирается на методику калмыцкого литературоведа <strong>Андрея Васильевича Бадмаева</strong> и его «Практический самоучитель старокалмыцкой письменности» (Элиста, 1971).</p>
            <p>Также хочется выразить огромную благодарность <strong>Арслану Оргаеву</strong> за его шрифт TodoPozdneevTomo, прописи, перенабранные пособия и в целом за огромный вклад в культуру; <strong>Геннадию Корнееву</strong> — за помощь в историческом блоке и важные детали биографии Зая-пандиты; <strong>Виктору Манджиеву</strong> — за экспертную оценку, помощь в написании примечаний к буквам, предоставленные пособия и поддержку на всех этапах. Благодарим также ЦРКЯ (Центр развития калмыцкого языка) и всех причастных, кто помогал осуществлению и развитию этого проекта.</p>

            <h3 class="about-h3">А. В. Бадмаев</h3>
            <figure class="about-portrait">
                <img src="img/badmaev.jpg" alt="Андрей Васильевич Бадмаев — литературовед, автор самоучителя старокалмыцкой письменности" loading="lazy" decoding="async" width="900" height="599">
                <figcaption>Андрей Васильевич Бадмаев (1939–2020).</figcaption>
            </figure>

            <p><strong>Андре́й Васи́льевич Бадма́ев</strong> родился 2 марта 1939 года на хуторе Попов в Волгоградской области. В годы депортации калмыков жил на Алтае, окончил там школу и в 1957 году поступил на калмыцкое отделение филологического факультета Ставропольского пединститута. В 1962 году стал учителем калмыцкого и русского языка и литературы, затем учился в аспирантуре Института народов Азии АН СССР; в 1963–1965 годах служил в армии.</p>
            <p>С 1967 года работал в Калмыцком научно-исследовательском институте языка, литературы и истории (КНИИЯЛИ), изучая дореволюционную калмыцкую литературу. В 1969 году защитил кандидатскую диссертацию о ранних памятниках ойратско-калмыцкой литературы XVII–XVIII веков. С 1975 года преподавал в университете, а с 1990 года шестнадцать лет заведовал кафедрой калмыцкой литературы. Кандидат филологических наук, член Союза писателей России, заслуженный деятель науки Республики Калмыкия, знаток тодо-бичиг. Скончался 16 января 2020 года.</p>
            <p>Он одним из первых системно исследовал литературные памятники на этой письменности: биографию Зая-пандиты, сказания ойратов, историю калмыцких ханов и другие тексты. В 1971 году вышла книга, по которой удобно учиться самому, шаг за шагом.</p>
            <blockquote class="about-quote">
                «Торопись медленно» — совет автора: переходите к новому, только прочно усвоив пройденное.
            </blockquote>
            <p>Этой логикой — от простого к сложному, без спешки — мы и держимся на сайте.</p>
    ...
    function renderCourse() {
        ...
        <div class="course-wrap">
            ...
            <p class="about-source">Маршрут составлен по методике: А. В. Бадмаева. «Практический самоучитель старокалмыцкой письменности». — Элиста, 1971.</p>
        </div>`;
    }
    ...
    // Простая вертикальная черта нурһн (ось письма) — обычная CSS-линия, без шрифта и SVG.
    function wrNurhunLine(size) {
        if (size === 'card') {
            return `<span class="wr-nurhun-line-track" aria-hidden="true"><span class="wr-nurhun-line wr-nurhun-line--card"></span></span>`;
        }
        return `<span class="wr-nurhun-line wr-nurhun-line--inline" aria-hidden="true"></span>`;
    }
    function wrNurhunRef() {
        return `<button type="button" class="wr-nurhun-ref" onclick="gotoChar('nurγun')" aria-label="нурһн — хребет, ось письма">
            ${wrNurhunLine('inline')}<span class="wr-nurhun-label">нурһн</span>
        </button>`;
    }
        ...
        return `
            <div class="wr-glyph-item wr-glyph-item--nurhun" role="button" tabindex="0" onclick="gotoChar('nurγun')"
                ...
                <div class="wr-nurhun-card">
                    ${wrNurhunLine('card')}
                    <span class="wr-nurhun-card-label">нурһн</span>
                </div>
                ${hint ? `<span class="wr-glyph-hint">${escapeHtml(hint)}</span>` : ''}
            </div>`;
    }
    function wrMnemonicFig(src, alt, caption, w, h) {
        const size = (w && h) ? ` width="${w}" height="${h}"` : '';
        return `<figure class="wr-mnemonic">
            <img src="${src}" alt="${escapeHtml(alt)}"${size} loading="lazy" decoding="async">
    ...
    function renderWritingRules() {
        ...
        const sections = [
            {
                title: 'Как устроено письмо',
                kind: 'основа',
                hint: 'как читать столбцы',
                toc: 'Страница',
                body: `
                    ...
                    <p>Столбцы идут <strong>слева\u00A0направо</strong>: дописали один до конца — переходят к следующему, правее. Так же устроена и классическая монгольская вертикальная письменность; Тодо\u00A0Бичик ведёт от неё своё начало и сохраняет тот же порядок чтения и письма на странице.</p>`
            },
            {
                title: 'Из чего состоит буква',
                kind: 'детали',
                hint: 'титм · аран · нурһн · удан',
                toc: 'Детали',
                body: `
                    ...
                    <p><strong>Титм</strong> (калм. титм — корона, венец) — верхний начальный элемент гласных и некоторых согласных (н, һ, х). По форме его сравнивают с короной: лёгкий штрих с крючком справа «венчает» букву сверху.</p>
                    ${wrMnemonicFig(
                        'img/titm-mnemonic.png',
                        'Титм: знак-корона слева и рисунок короны справа',
                        'Титм — «корона» буквы: слева элемент письма, справа мнемоника.',
                        723, 465
                    )}
                    <p><strong>Аран</strong> (калм. аран — зубец, зуб; иногда говорят шүдн) — короткий зубец, отходящий от вертикального хребта. По форме его сравнивают с пилой: зубцы «пилят» вправо от оси.</p>
                    ${wrMnemonicFig(
                        'img/aran-mnemonic.png',
                        'Аран: знак-зубец слева и рисунок пилы справа',
                        'Аран — «зубец»: слева элемент письма, справа пила как мнемоника.',
                        640, 219
                    )}
`
            },
            {
                ...
                body: `
                    ...
                    <div class="about-steps">
                        <div class="about-step"><span class="about-step-n">1</span><div class="about-step-body"><p>Для части согласных (н, һ, х) добавьте верхнюю «корону», с которой начинается буква:</p>${wrGlyph('titm', '«корона»')}</div></div>
                        <div class="about-step"><span class="about-step-n">2</span><div class="about-step-body"><p>Допишите основной элемент буквы — обычно это зубец, отходящий от центральной оси:</p>${wrGlyph('aran', '«зубец»')}</div></div>
                    ...
                    <p class="wr-next-link">Пошаговую анимацию и пропись смотрите в разделе <a class="note-link" role="link" tabindex="0" onclick="showSection('direction');return false;">«Направление письма»</a>.</p>`
            },
            {
                title: 'Три формы буквы',
                kind: 'формы',
                hint: 'начало · середина · конец',
                toc: 'Формы',
                body: `
                    <p>У большинства букв — три формы начертания в зависимости от места в слове:</p>
                    <div class="wr-form-grid">
                        <div class="wr-form-card">
                            <div class="wr-form-card-title">Начальная</div>
                            <p>У некоторых согласных пишут знак «титм» («корона»):</p>
                            <div class="wr-glyphs-after">${wrGlyph('titm', 'корона')}</div>
                        </div>
                        <div class="wr-form-card">
                            <div class="wr-form-card-title">Срединная</div>
                            <p>Буква внутри слова, между двумя другими знаками.</p>
                        </div>
                        <div class="wr-form-card">
                            <div class="wr-form-card-title">Конечная</div>
                            <p>Последняя буква слова; у ряда согласных отдельной конечной формы нет.</p>
                        </div>
                    </div>
                    ...
                    <div class="wr-glyph-row">
                        ${wrGlyph('t', null, 'initial')}
                        ${wrGlyph('c, č')}
                        ${wrGlyph('z, ǰ')}
                        ${wrGlyph('x', null, 'initial')}
                        ${wrGlyph('y')}
                    </div>
                    <p>После «круглых» согласных — б, п, г, к — конечные «а» и «и» получают откидные (конечные) формы букв: «а» с чертой и киисвр сүүлтә «и». В остальных случаях, включая позицию после гласных, — обычные.</p>
            ...
            },
            {
                ...
                body: `
                    ...
                    <div class="wr-n-grid">
                        ${wrNCard('1. Перед гласной', '«н» получает точку', 'онон', '', 'Дальше идёт гласная, поэтому у «н» ставится различительная точка.', 'dot')}
            ...
            },
            {
                ...
                kind: 'ряды',
                hint: 'гласные · согласные',
                toc: 'Гласные',
                body: `
                    <p><strong>Гласные</strong> — семь основных (а, э, и, о, у, ө, ү), плюс их долгие варианты и дифтонги с «й».</p>
                    <div class="wr-glyph-row">
                        ${wrGlyph('a', 'начальная', 'initial')}
                        ${wrGlyph('a', 'срединная', 'medial')}
                        ${wrGlyph('a', 'конечная', 'final')}
                        ${wrGlyph('ā', 'долгая')}
                        ${wrGlyph('ayi', 'дифтонг · ай')}
                    </div>
                    ...
                    <div class="wr-glyphs-after">${wrGlyph('uru_tatasn')}</div>
                    ...
                    <div class="wr-ref-block">
                        <div class="wr-mini-title">Справочник: порядок штрихов</div>
            ...
            {
                title: 'Круглые согласные и слоги',
                kind: 'лигатуры',
                hint: 'как буквы соединяются',
                toc: 'Слоги',
                body: `
                    ...
                    <div class="wr-glyphs-after">${wrGlyph('b1', 'круглая согласная')}</div>
                    ...
                    <div class="wr-glyphs-after">${wrGlyph('na', 'слог · начальная', 'initial')}</div>`
            },
            {
                title: 'Галики, пунктуация, цифры',
                kind: 'справочник',
                hint: 'дополнительные знаки',
                toc: 'Знаки',
                body: `
                    ...
                    <table class="wr-table">
                        ...
                        <tbody>
                            ...
                            <tr><td class="wr-td-glyph">${wrTdGlyph('p_f_γaliq1')}</td><td>п/ф-галик — читается «пха»/«ф»; позже и в словах через русский: февраль, Пётр, полковник</td></tr>
                    ...
                    <div class="wr-glyphs-after">${wrGlyph('č', 'изначально галик')}</div>
                    ...
                    <div class="wr-mini-title">Пунктуация</div>
                    ...
                    ${wrGlyphRow([
                        ...
                        ['comma', 'логическое деление'],
                        ['colon', 'конец предложения']
                    ])}
                    <div class="wr-mini-title">Цифры</div>
                ...
                body: `
                    <div class="wr-mistake-grid">
                        <div class="wr-mistake">
                            ...
                            <div class="wr-mistake-good"><span class="wr-mistake-tag">Верно</span><span>Помнить про слоговой принцип: после ряда согласных (т, ц/ч, з, х, й и др.) в Тодо Бичик всегда должна идти гласная, поэтому на конце слова этих букв не бывает вовсе.</span></div>
                        </div>
                        <div class="wr-mistake">
                        ...
                        <div class="wr-mistake">
                            ...
                            <div class="wr-mistake-glyphs">${wrGlyph('g1')} ${wrGlyph('k1', null, 'medial')}</div>
        ...
        const toc = `<nav class="wr-toc" aria-label="Содержание правил">
            ${sections.map((s, i) =>
                `<button type="button" class="wr-toc-chip" onclick="wrOpenRule(${i})">${escapeHtml(s.toc || String(i + 1))}</button>`
            ).join('')}
        </nav>`;
            ...
            <div class="wr-hero">
                <div class="wr-hero-main">
                    ...
                    <div class="wr-hero-actions">
                        ...
                        <button type="button" class="wr-action-link" onclick="wrToggleRules(false)">Свернуть всё</button>
                    </div>
                </div>
            </div>
            ${toc}
            ${sections.map((s, i) => `
                <details class="wr-acc" id="wr-acc-${i}"${i === 0 ? ' open' : ''}>
                    <summary>
                        ...
                        <span class="wr-acc-kind">${escapeHtml(s.kind || 'правило')}</span>
                        <span class="wr-acc-chev" aria-hidden="true">▾</span>
                    </summary>
                    <div class="wr-acc-body">${s.body}</div>
                </details>`).join('')}
            <p class="about-source">По материалам самоучителя: А. В. Бадмаева. «Практический самоучитель старокалмыцкой письменности». — Элиста, 1971.</p>
        </div>`;
    }
    ...
    function wrReplayNurhunAnim(card) {
        if (!card || window.matchMedia('(prefers-reduced-motion: reduce)').matches) return;
        card.querySelectorAll('.wr-nurhun-line--card, .wr-nurhun-card-label').forEach(el => {
        ...
        if (placedEl) {
            placedEl.innerHTML = composeState.placed.map((iid, i) => {
                ...
                return `<span class="cw-chip${clCls}" onclick="composeRemoveAt(${i})" title="Убрать">
                            <span class="cw-chip-num">${i + 1}</span>${escapeHtml(t.label || composeLabel(lt, { pos: i, letters: placedLetters }))}<span class="cw-chip-x">✕</span>
                        </span>`;
            }).join('');
        }
        // Поднос плиток
    ...
    // Буква в конечной позиции слова (учитывает пробелы idx -1 и знаки препинания).
    function composeLetterIsFinal(pos, letters) {
        if (!letters[pos] || letters[pos].idx === -1) return false;
        let segStart = 0;
        for (let i = 0; i <= letters.length; i++) {
            const atSep = i === letters.length || (letters[i] && letters[i].idx === -1);
            if (!atSep) continue;
            const segEnd = i;
            if (pos >= segStart && pos < segEnd) {
                const word = letters.slice(segStart, segEnd);
                const relPos = pos - segStart;
                const groups = splitPunctGroups(word);
                for (let gi = 0; gi < groups.length; gi++) {
                    const g = groups[gi];
                    if (relPos >= g.start && relPos < g.start + g.letters.length) {
                        return relPos === g.start + g.letters.length - 1;
                    }
                }
                return relPos === word.length - 1;
            }
            segStart = i + 1;
        }
        return false;
    ...
    // opts.pos + opts.letters — для дифтонгов в конце слова: айи→ай, эйи→эй…
    function composeLabel(lt, opts) {
        if (!lt) return '';
        if (opts && opts.pos != null && opts.letters
            && lt.category === 'diphthongs' && composeLetterIsFinal(opts.pos, opts.letters)
            && DIPHTHONG_FINAL_CYR[lt.idx]) {
            return DIPHTHONG_FINAL_CYR[lt.idx];
        }
    ...
    function wwParse(str) {
        ...
        while (i < s.length) {
            ...
            if (WW_TRI[three] !== undefined) {
                ids.push(WW_TRI[three]); i += 3; continue;
            }
            const two = s.substr(i, 2);
            if (WW_DI[two] !== undefined) {
                // Дифтонг на «й» (айи, эйи, ийи, ойи, уйи, өйи, үйи; также краткие ай, эй…):
            ...
            // Мягкий знак «ь» отдельного знака в Тодо Бичик не имеет и на письме
    ...
    function wwNormalizeInput() {
        ...
        if (norm !== old) {
            ...
            const newPos = wwNormalizeCyr(old.slice(0, pos)).length;
            inp.value = norm;
    ...
    function renderSyllables() {
        const syls = charsByCategory.syllables || [];
