   ...
   слова, силлабарий, конструктор «Составить слово» и «Написать слово», карточки). */
    ...
    function renderAbout() {
        ...
        <div class="about-wrap">
            ...
            <p class="about-lead">Добро пожаловать на специализированный сайт, полностью посвящённый <strong>Тодо Бичик</strong> (ойр. ᡐᡆᡑᡆ ᡋᡅᡔᡅᡎ — «ясное, чёткое письмо») — одной из самых совершенных и самобытных письменных систем в монгольском мире.</p>
